...
Como un resultado importante se destaca la creaci\'{o}n del paquete \pkg{ZOIP}. Este paquete tiene varias funciones importantes como lo son la funci\'{o}n de densidad de probabilidad, de distribuci\'{o}n acumulada, y la funci\'{o}n cuantil y un generador de n\'{u}meros aleatorios. Por otra parte, el paquete permite ajustar distribuciones ZOIP o modelos de regresi\'{o}n ZOIP, mediante algoritmos de optimizaci\'{o}n, como \code{nlimnb} u \code{optim}. Tambi\'{e}n es posible ajustar los modelos de regresi\'{o}n ZOIP mixtos, v\'{\i}a m\'{a}xima verosimilitud usando la cuadratura de Gauss-Hermite adaptativa. El paquete \pkg{ZOIP} tambi\'{e}n incluye sobre el ajuste de los modelos, algunas funciones de m\'{e}todo S3.\\
...
\item Incluir pendientes aleatorias en los diferentes par\'{a}metros de la regresi\'{o}n ZOIP.
	...
	\item Optimizar los algoritmos propuestos en el paquete \pkg{ZOIP}, para que el tiempo de estimaci\'{o}n de los par\'{a}metros sean m\'{a}s corto.
