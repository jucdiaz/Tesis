...
El art\'{\i}culo se encuentra organizado de la siguiente manera: primero se presenta la distribuci\'{o}n ZOIP, en la siguiente secci\'{o}n el modelo de regresi\'{o}n ZOIP y su debida estimaci\'{o}n, en la secci\'{o}n n\'{u}mero cuatro se presenta unas aplicaciones a datos simulados y a datos reales y por \'{u}ltimo se presenta la implementaci\'{o}n del modelo de regresi\'{o}n ZOIP en el paquete \pkg{ZOIP} de \proglang{R}.
