\chapter{Cap\'{\i}tulo 2: Modelo de regresi\'{o}n ZOIP con efectos fijos}
...
\section{Modelo de regresion ZOIP en el Paquete \pkg{ZOIP}}
...
La funci\'{o}n \code{RM.ZOIP} estima los par\'{a}metros de un modelo ZOIP con y sin covariables v\'{\i}a m\'{a}xima verosimilitud utilizando el optimizador \code{nlminb} o \code{optim}. La estructura de la funci\'{o}n \code{RM.ZOIP} es la siguiente:
